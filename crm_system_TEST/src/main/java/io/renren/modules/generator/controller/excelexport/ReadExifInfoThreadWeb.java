...
public class ReadExifInfoThreadWeb  implements Callable<List<ExcelWorkbenchDto>> {
    ...
    public ReadExifInfoThreadWeb(QueryCondition queryCondition, CrmWorkbenchService crmWorkbenchService, int i, int num, Map<String, Object> params, HttpServletResponse response, CountDownLatch latch) {
        this.queryCondition = queryCondition;
        this.crmWorkbenchService = crmWorkbenchService;
        this.i = i;
        this.num = num;
