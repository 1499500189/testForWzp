...
public class ReadExifInfoThreadOne implements Callable<List<ExcelWorkbenchDto>> {
    ...
    public ReadExifInfoThreadOne(QueryCondition queryCondition, CrmWorkbenchService crmWorkbenchService, int i, int num, Map<String, Object> params) {
    ...
    public List<ExcelWorkbenchDto> call(){
        ...
        try{
            ...
            logger.info(Thread.currentThread().getName()+"写入耗时："+ennTime);
            return exifInfoList;
        }catch (Exception e){
            e.getStackTrace();
